...
module "Kv-DemoVault" {
  ...
  KeyVaultRgName = azurerm_resource_group.Rg_Demo.name
  #KeyVaultSkuName = "standard" #Optional. Default value is "standard"
  KeyVaultTenantID = "" #Required! your tenant ID 
  ...
  ProvisioningDateTag = "today :)" #you van use timestamp(). This Tag is configured to NOT be updated unless resource is destroyed
